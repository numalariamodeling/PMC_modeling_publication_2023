...
## Fig_A1.2.6-7_dose_impact_EIR.R
##---------------------
...
f_save_plot(pplot, paste0('Fig A1.2.6'), file.path(plot_dir), width = 12, height = 6, units = 'in', device_format = device_format)
#fwrite(plotdat, file.path(plot_dir, 'csv', 'Fig A1.2.6_dat.csv'))
...
f_save_plot(pplot2, paste0('Fig A1.2.7'), file.path(plot_dir), width = 12, height = 8, units = 'in', device_format = device_format)
#fwrite(plotdat, file.path(plot_dir, 'csv', 'Fig A1.2.7_dat.csv'))
